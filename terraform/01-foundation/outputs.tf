...
output "sandbox_build_trigger_id" { value = google_cloudbuild_trigger.sandbox_orchestrate.trigger_id }
...
output "automation_image" { value = local.automation_image_uri }
